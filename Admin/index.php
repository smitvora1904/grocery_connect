                                        ...
                                        <div class="chart-info">
                                            ...
                                            <div class="chart-info__right">
                                                <div class="chart-statis">
                                                    ...
                                                    <span class="label">Rajkot</span>
                                                </div>
                                                <div class="chart-statis mr-0">
                                                    <span class="index decre">
                                                        <i class="zmdi zmdi-long-arrow-down"></i>10%</span>
                                                    <span class="label">Jamnagar</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>30 September, 2020</h3>
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Order ID: 1000398</a>
                                                    </h5>
                                                    <span class="time">On Delivery: Manish</span>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="images/icon/avatar-02.jpg" alt="admin">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">John Smith</h5>
                                                                <p>Great Place to SHOP Groceries!!!</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
