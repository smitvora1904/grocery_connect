        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="col-lg-9" style="margin-top: 10px; width: 800px">
                                <h2 class="title-1 m-b-25">Seller Members</h2>
                                   ...
                                   echo "<table class='table table-borderless table-striped table-earning' style='width:1175px'>";
                                        echo "<thead>";
                                            echo "<tr>";
                                                ...
                                                echo "<th style='width:35px'>address</th>";
                                                echo "<th style='width:35px'></th>";
                                            echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody>";

                                        $sql = "select * from seller_details where status = 1";
                                        $result = mysqli_query($conn,$sql);
                                        while ($row=mysqli_fetch_array($result)) {
                                            ...
                                            echo "<a style='height: 25px;width: 55px;background-color: green;color: white;'  href='./delete.php?id=".$row['seller_id']."'> Delete </a>";
                                            //echo "</form>";
                                            echo "</td>";
