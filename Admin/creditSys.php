    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <form class="form-header" action="" method="POST">
                    <form>
                        <input type="button" name="addstock" value="Seller Book" style="height: 50px; width:140px;margin-left: 800px;background-color: #28A745 ;color:white" onclick="window.location.href = 'cust_book.php'">
                    </form>
                                   ...
                                   echo "<table class='table table-borderless table-striped table-earning' style='width:1175px'>";
                                        echo "<thead>";
                                            echo "<tr>";
                                                ...
                                                echo "<th style='width:35px'>Shop Name</th>";
                                                echo "<th style='width:35px'>contact</th>";
                                                echo "<th style='width:35px'>email</th>";
                                                echo "<th>address</th>";
                                        ...
                                        $sql = "select * from seller_details where status = 0";
                                        $result = mysqli_query($conn,$sql);
                                        while ($row=mysqli_fetch_array($result)) {
                                            ...
                                            echo "<a name='accpt' id=".$row['seller_id']." value = 'A' style='height: 25px;width: 25px;background-color: green;color: white;' href='./accept.php?id=".$row['seller_id']."'>  A </a>";
                                            echo "<a style='height: 25px;width: 25px;background-color: red;color: white;' href='./reject.php?id=".$row['seller_id']."'>  R </a>";
                                            //echo "</form>";
                                            echo "</td>";
