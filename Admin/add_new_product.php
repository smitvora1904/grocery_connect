                                ...
                                <div class="card"style="width: 900px;margin-left:100px">
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="select" id="sc" class="form-control" style="margin-top: 10px;margin-right: 50px;width:600px">
                                                        <option value="0">Choose here from Existing Category</option>
                                                        <option value="1">Biscuits</option>
                                                        <option value="2">Personal Care</option>
                                                        <option value="3">Cereals & Pulses</option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text" id="tx2" name="text-input" placeholder="Enter new Category" class="form-control" style="margin-right: 50px;width:600px;margin-left: 230px"><br>
                                                </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="select" id="sb" class="form-control" style="margin-top: 10px;margin-right: 50px;width:600px">
                                                        <option value="0">Choose here from Existing Brand</option>
                                                        <option value="1">Parle</option>
                                                        <option value="2">Cinthol</option>
                                                        <option value="3">Ratio</option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <label id="tx1" style="margin-left: 250px">OR</label>
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text" id="tx2" name="text-input" placeholder="Enter new Brand" class="form-control" style="margin-right: 50px;width:600px;margin-left: 230px"><br>
                                                </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text" id="tx2" name="text-input" placeholder="Enter Product" class="form-control" style="margin-right: 50px;width:600px;"><br>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text" id="tx2" name="text-input" placeholder="Enter price" class="form-control" style="margin-right: 50px;width:600px;"><br>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <input type="text" id="tx2" name="text-input" placeholder="Enter Number of Units " class="form-control" style="margin-right: 50px;width:600px;"><br>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                     <textarea name="textarea-input" id="tx3" rows="9"   class="form-control" style="height: 100px;width: 600px"></textarea>
                                                </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm"onclick="window.location.reload();" style="margin-left: 300px">
