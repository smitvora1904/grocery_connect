...
<head>
    <!-- Required meta tags-->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-widtsh, initial-scale=1, shrink-to-fit=no">
                                ...
                                <div class="card"style="width: 900px;margin-left:100px">
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="select" id="select" class="form-control" style="margin-top: 10px;margin-right: 50px;width:600px">
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="select" id="select" class="form-control" style="margin-top: 10px;margin-right: 50px;width:600px">
                                                        <option value="0">Please select</option>
                                                        <option value="1">Parle-G</option>
                                                        <option value="2">Bathing Soap</option>
                                                        <option value="3">Mung Daal</option>
                                                    </select>
                                                </div>
                                    </div>
                                    ...
                                    <div class="row form-group" style="margin-left: 20px;margin-top: 10px;">
                                        <div class="col col-md-3">
                                        <button type="button" class="btn btn-primary btn-sm" style="background-color: #28A745;">
                                            <i class="fa fa-dot-circle-o"></i> View Item
                                        </button>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="text-input" placeholder="20" class="form-control" disabled="True" style="margin-right: 50px;width:600px">
