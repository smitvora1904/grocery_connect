                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="stname" name="text-input" placeholder="Name" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="stphn" name="text-input" placeholder="Phone Number" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="staltphn" name="text-input" placeholder="Alternate Phone Number" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="stdesig" name="text-input" placeholder="Delivery Boy, Supervisor, etc.." class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input style="width: 200px;" type="text" id="stage" name="text-input" placeholder="Age" class="form-control">
                                                </div>
                                            </div>     
                                                ...
                                                <div class="col col-md-9">
                                                    <div class="form-check-inline form-check">
                                                        <label for="inline-radio1" class="form-check-label ">
                                                            <input type="radio" id="stgenderM" name="stgender" value="male" class="form-check-input">Male
                                                        </label>
                                                        <label style="margin-left: 10px;" for="inline-radio2" class="form-check-label ">
                                                            <input type="radio" id="stgenderF" name="stgender" value="female" class="form-check-input">Female
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="stphoto" name="file-input" class="form-control-file">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="stadhaar" name="file-input" class="form-control-file">
                                                </div>
                                            </div>
