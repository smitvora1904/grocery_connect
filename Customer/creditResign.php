...
<!--login-->
	...
	<div class="login" id="loginPage" hidden="true">
		...
		<div id="checkoutPage" hidden="true">
			<?php
				$sql = "select seller_id,current_due_amt from credit_customers where cust_id=".$_COOKIE['user'];
    			$result = mysqli_query($conn,$sql);
        		$row = mysqli_fetch_array($result);
			...
			<div class="spec " align="left">
				...
				<div class=" con-w3l" align="left" style="margin-top: 10px;">
					<p style="font-size: 24px;color: red;">
						You will Resign as Credit Customer from <?php echo $row2['shop_name'] ?>
					</p>
            	<?php
    			...
    			<h2 class='t-button'>
				<button name='place'><span class='label label-danger' style='float: left;margin-right: 30px;'>Resign</span></button>
			  </h2>
    			</div>
    			</form>";
    			}
