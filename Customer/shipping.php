				...
				<!-- First Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Delivery charges depend upon the distance and items purchased from the perticular seller. It is under seller's policy.</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse">
							<div class="panel-body">
								<p>You must contact  and consult with the seller you have selected to purchase goods from. Its under seller's policy.</p>
							</div>
						</div>
					</div>
					<!-- Fifth Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseFive" class="panel-collapse collapse">
							<div class="panel-body">
								<p>By placing a minimum order of Rs. 500 /-</p>
							</div>
						</div>
					</div>
					<!-- Sixth Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseSix" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Please check the order status, it might be cancelled by the seller you selected. OR some problem can occur in transit. So, please contact the perticular seller.</p>
							</div>
						</div>
					</div>
