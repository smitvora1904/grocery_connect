...
<!--login-->
	...
	<div class="login" id="loginPage" hidden="true">
		...
		<div id="checkoutPage" hidden="true">
			<?php
				$sql = "select * from orders_log where status=3 and cust_id=".$_COOKIE['user'];
        		$result = mysqli_query($conn,$sql);
				$sql2 = "select * from orders_log where status in(1,2) and cust_id=".$_COOKIE['user'];        		
				$result2 = mysqli_query($conn,$sql2);

				$sql3 = "select * from orders where cust_id=".$_COOKIE['user'];        		
	...
	<div class="product" style="padding-top: 20px;padding-bottom: 10px;">
		<div class="container">
			<div class="spec " align="left">
				<h3 id="heading" align="left" style="color: #f19210;">Orders - In Delivery Process</h3>
				</div>
              ...
              <tbody>
                <?php
					while($row = mysqli_fetch_array($result))
					{
						...
						$pro = explode("#",$row['products']);
						echo "<td>";
						for($i=0;$i<(count($pro)-1);$i++)
						{
							$sqlT = "select name from product_details where prod_id=".$pro[$i];
	...
	<div class="product" style="padding-top: 20px;padding-bottom: 10px;">
		<div class="container">
			<div class="spec " align="left">
				<h3 id="heading" align="left" style="color: #f19210;">Orders - Just Placed</h3>
				</div>
				<div class=" con-w3l" align="left" style="margin-top: 10px;">
					<table class="table table-striped">
              <thead>
	...
	<div class="product" style="padding-top: 20px;padding-bottom: 10px;">
		<div class="container">
			<div class="spec " align="left">
				<h3 id="heading" align="left" style="color: #f19210;">Past Orders</h3>
				</div>
				<div class=" con-w3l" align="left" style="margin-top: 10px;">
					<table class="table table-striped">
              <thead>
