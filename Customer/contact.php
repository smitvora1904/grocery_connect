		...
		<div class=" contact-w3">	
			...
			<div class="col-md-7 contact-left">
				...
				<ul class="contact-list">
					<li> <i class="fa fa-map-marker" aria-hidden="true"></i>Morbi Road, Marwadi University, Rajkot Gujarat</li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:groceryconnect18@gmail.com">groceryconnect18@gmail.com</a></li>
					<li> <i class="fa fa-phone" aria-hidden="true"></i>+91 9426729507 , +91 9687913890</li>
				</ul>
				<div id="container">
					<!--Horizontal Tab-->
					<div id="parentHorizontalTab">
						...
						<div class="resp-tabs-container hor_1">
							...
							<div>
								...
								<h5>Our Branches</h5>
									<ul>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Morbi Road, Marwadi University, Rajkot Gujarat</li>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Jamnagar,Gujarat</li>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Mahuva,Gujarat</li>
									</ul>
								</div>
							</div>
							<div>
								<div class="map-grid">
									...
									<ul>
										<li>Mobile No : +91 9426729507</li>
										<li>Office No : +91 9687913890</li>
									</ul>
								</div>
							</div>
						</div>
