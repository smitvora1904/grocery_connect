...
<div class="banner-top">
	<div class="container">
		<h3 >Terms</h3>
		<h4><a href="index.php">Home</a><label>/</label>Terms</h4>
		<div class="clearfix"> </div>
	</div>
</div>
			...
			<div class="terms">
				...
				<div class="ser-t">
					...
					<div class="ter-wthree">
						<h6><span>1.</span>Payment</h6>
						<p>Payment Policies can vary from seller to seller as per their facilities.</p>
						
					</div>
					<div class="ter-wthree">
						<h6> <span>2.</span>Cancellation Policy</h6>
						<p>Cancel your order before its dispatched. Otherwise seller might charge some cancelation amount.</p>
					</div>
					<div class="ter-wthree">
						<h6><span>3.</span>Modifications & Refunds</h6>
						<p>Order details can not be modified once placed. On cancelation refunds will be processed in 1 or 2 working days.</p>
					</div>
					<div class="ter-wthree">
						<h6><span>4.</span>Availability</h6>
						<p>Please select seller before placing order. Stocks vary for all sellers.</p>
					</div>
				</div>
			</div>
			<!--- /terms ---->
