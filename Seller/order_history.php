        ...
        function filterD(){
...

            {
                ...
                if (this.readyState==4 && this.status==200) {
                    document.getElementById('executedTable').innerHTML = this.responseText;
                }
                }
                xmlhttp.open("GET","getexecutedTable.php?value=1&val="+val, true);
                xmlhttp.send();
            }
        }
        function filterD2(){
...

            {
                ...
                xmlhttp.onreadystatechange= function(){
                if (this.readyState==4 && this.status==200) {
                    document.getElementById('cancelledTable').innerHTML = this.responseText;
                }
                }
                xmlhttp.open("GET","getexecutedTable.php?value=11&val="+val, true);
                xmlhttp.send();
            }
        }
        function filterO(){
            ...
            xmlhttp.open("GET","getexecutedTable.php?value=2&val="+val, true);
            xmlhttp.send();
            }
        }
        function filterO2(){
            ...
            xmlhttp.open("GET","getexecutedTable.php?value=22&val="+val, true);
            xmlhttp.send();
            }
        }
        function filterC(){
            ...
            xmlhttp.open("GET","getexecutedTable.php?value=3&val="+val, true);
            xmlhttp.send();
            }
        }
        function filterC2(){
            ...
            xmlhttp.open("GET","getexecutedTable.php?value=33&val="+val, true);
            xmlhttp.send();
            }
        }
    </script>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <form class="form-header" action="" method="POST">
                    <input class="au-input au-input--xl" type="text" name="stock" id="stock" placeholder="Search for Orders" style="margin-left: 150px">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(800px, 159px, 0px); top: 0px; left: 0px; will-change: transform;">

                        <a class="dropdown-item" href="#" onclick="filterD();filterD2()">Date</a>
                        <a class="dropdown-item" href="#" onclick="filterO();filterO2()">Order Id</a>
                        <a class="dropdown-item" href="#" onclick="filterC();filterC2()">Customer Id </a>
                    </div>
                ...
                <div class="col-lg-9" style="margin-top: 10px; width: 800px">
                                <h2 class="title-1 m-b-25">Executed Orders</h2>
                                <div  style="width: 300px">
                                    <?php
                                    echo "<table class='table table-borderless table-striped table-earning' style='width:1175px'>";
                                        echo "<thead>";
                                           echo "<tr>";
                                                echo "<th style='width:35px'>date</th>";
                                                echo "<th style='width:35px'>Order ID</th>";
                                                echo "<th style='width:35px'>Customer name</th>";
                                                echo "<th style='width:35px'>Customer Contact</th>";
                                                echo "<th style='width:35px'>City</th>";
                                                echo"<th>Total Amount</th>";
                                            echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody id='executedTable' name='executedTable'>";
                                        $sql="select order_id,cust_id from orders_log where seller_id=".$_SESSION['seller_id']." and status in(1,2)"; 

                                        $result = mysqli_query($conn,$sql);
                                        while ($row=mysqli_fetch_array($result)) {
                                        $sql2="select order_id,cust_id,total_amt,date from orders_log where order_id=".$row['order_id'];
                                        $result2 = mysqli_query($conn,$sql2);
                                        $row2=mysqli_fetch_array($result2);

                                        $sql3="select name,contact,city from customer_details where cust_id=".$row['cust_id'];
                            ...
                            <br><br>
                             <div class="col-lg-9" style="margin-top: 10px; width: 800px">
                                <h2 class="title-1 m-b-25">Cancelled Orders</h2>
                                <div  style="width: 300px">
                                    <?php
                                    echo "<table class='table table-borderless table-striped table-earning' style='width:1175px'>";
                                        echo "<thead>";
                                            ...
                                            echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody id='cancelledTable' name='cancelledTable'>";
                                        $sql="select order_id,cust_id from orders_log where seller_id=".$_SESSION['seller_id']." and status=0"; 
                                        $result = mysqli_query($conn,$sql);
                                        while ($row=mysqli_fetch_array($result)) {
                                        $sql2="select order_id,cust_id,total_amt,date from orders_log where order_id=".$row['order_id'];
                                        $result2 = mysqli_query($conn,$sql2);
