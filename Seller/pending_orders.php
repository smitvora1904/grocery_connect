                            ...
                            <div class="col-lg-6">
                                <div class="card" style="width: 1200px">
                                    <div class="card-header">
                                        <strong>Customer Pending Orders</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="processPendingOrders.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                            <?php
                                            error_reporting(0);
                                            $sql = "select * from orders where seller_id=".$_SESSION['seller_id'];
                                                    $result = mysqli_query($conn,$sql);
                                                    $row = mysqli_fetch_array($result);
                                            $sql2="select name,contact from customer_details where cust_id=".$row['cust_id'];
                                            $result2 = mysqli_query($conn,$sql2);
                                            $row2 = mysqli_fetch_array($result2);

                                            echo "<div class='row form-group' style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-email' class= form-control-label'>Order ID</label>";
                                                echo "</div>";
                                                echo "<div class='col-12 col-md-9'>";                                                    
                                                    echo "<span class='help-block'>".$row['order_id']."</span>";
                                            ...
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-password' class=' form-control-label'>Customer Name</label>";
                                                echo "</div>";
                                                echo "<div class='col-12 col-md-9'>";
                                                    echo "<span class='help-block'>".$row2['name']."</span>";

                                                echo "</div>";
                                            echo "</div>";
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-password' class=' form-control-label'>Customer Contact</label>";
                                                echo "</div>";
                                                echo "<div class='col-12 col-md-9'>";
                                                    echo "<span class='help-block'>".$row2['contact']."</span>";
                                                echo "</div>";
                                            echo "</div>";
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<br>";
                                                    echo "<label for='hf-password' class=' form-control-label'><strong>Items to Deliver</strong></label>";
                                                echo "</div>";
                                            echo "</div>";
                                            echo "<div class='col-lg-9' style='margin-top: 10px; width: 800px;margin-left: 0px'>";
                                                echo "<div>";
                                                    echo "<table class='table table-borderless table-striped table-earning' style='width:1140px;table-layout: fixed;'>";
                                                    echo "<thead>";

                                                    echo "<tr>";

                                                        echo "<th style='padding: 22px 250px 22px 40px;width: 10px;'>Category</th>";
                                                        echo "<th style='padding: 22px 250px 22px 40px;width: 10px'>Brand</th>";
                                                        echo "<th style='padding: 22px 250px 22px 40px;width: 10px'>Product</th>";
                                                        echo "<th style='padding: 22px 50px;width: 20px'>Quantity</th>";
                                                        echo "<th style='padding: 22px 50px;width: 10px'>Price</th>";
                                                    echo "</tr>";
                                                    echo "</thead>";
                                                    echo "<tbody>";
                                                    ...
                                                    {
                                                    $sql3="select name,brand_id,category_id,price from product_details where prod_id=".$product[$i];
                                                    $result3=mysqli_query($conn,$sql3);
                                                    $row3=mysqli_fetch_array($result3);

                                                    $sql4="select brand from brand where brand_id=".$row3['brand_id'];
                                                    $result4=mysqli_query($conn,$sql4);
                                                    $row4=mysqli_fetch_array($result4);
                                                    $sql5="select category from product_category where category_id=".$row3['category_id'];
                                            ...
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-password' class=' form-control-label'>Total items</label>";
                                                echo "</div>";
                                                $len=count($product)-1;
                                                echo "<div class='col-12 col-md-9'>";
                                                    echo "<span class='help-block'>".$len."</span>";
                                                echo "</div>";
                                            echo "</div>";
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-password' class='form-control-label'>Total Amount</label>";
                                                echo "</div>";
                                                echo "<div class='col-12 col-md-9'>";

                                                    echo "<span class='help-block'>".$row['total_amt']."</span>";
                                                echo "</div>";
                                            echo "</div>";
                                            echo "<div class='row form-group'style='margin-left: 20px'>";
                                                echo "<div class='col col-md-3'>";
                                                    echo "<label for='hf-password' class='form-control-label'>Payment Method</label>";
                                                echo "</div>";
                                                echo "<div class='col-12 col-md-9'>";
                                                    echo "<span class='help-block'>".$row['payMode']."</span>";
                                                echo "</div>";
                                            echo "</div>";
                                            ?>
                                        <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm" name="btn" id="approvebtn" value="Approve" style="margin-left: 350px;background-color:#28A745">Approve
                                        </button>
                                        <button type="submit" class="btn btn-primary btn-sm" name="btn" id="cancelbtn" value="Cancel" style="margin-left: 20px;background-color:red">Cancel
                                        </button>
                                        </div>
                                        </form>
                                    </div>
