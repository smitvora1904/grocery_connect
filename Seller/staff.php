...
<nav class="navbar-sidebar">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <form class="form-header" action="" method="POST">
                    <form>
                        <input type="button" name="addstaff" value="ADD STAFF" style="height: 50px; width:140px;margin-left: 800px;background-color: #28A745 ;color:white" onclick="window.location.href = 'addStaff.php'">
                    </form>
                ...
                <div class="col-lg-9" style="margin-top: 10px; width: 800px">
                                <h2 class="title-1 m-b-25">Staff Members</h2>
                                <div  style="width: 300px">
                                <?php
                                   echo "<table class='table table-borderless table-striped table-earning' style='width:1175px'>";
                                        echo "<thead>";
                                            echo "<tr>";
                                                echo "<th style='width:35px'>staff ID</th>";
                                                echo "<th style='width:35px'>Name</th>";
                                                echo "<th style='width:35px'>contact</th>";
                                                echo "<th style='width:35px'>designation</th>";
                                                echo "<th style='width:35px'>orders served</th>";
                                                echo "<th>Delete</th>";
                                            echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody>";

                                        $sql = "select * from staff where seller_id=".$_SESSION['seller_id'];
                                        $result = mysqli_query($conn,$sql);
                                        while ($row=mysqli_fetch_array($result)) {
                                            $sql2 = "select count(order_id) from orders_log where staff_id=".$row['staff_id']." and seller_id=".$_SESSION['seller_id']; 
                                            ...
                                            echo "<a style='text-align: center;margin-left: 20px;height: 25px;width: 50px;background-color: red;color: white;' href='./deleteStaff.php?id=".$row['staff_id']."'>  Delete </a>";
                                            //echo "</form>";
                                            echo "</td>";
