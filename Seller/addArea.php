...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            area = document.getElementById("areanm");
            zip = document.getElementById("zip");

            areaPttrn = /[a-zA-Z]/;
            zipPttrn = /[0-9]/;

            if(!area.value.match(areaPttrn))
            {
                document.getElementById("arF").innerHTML= "Area not in correct format.";
                area.focus();
                return false;
            }
            else
            {
                document.getElementById("arF").innerHTML= " ";
            }


            if((!zip.value.match(zipPttrn)) || (zip.value.length !=6))
            {
                document.getElementById("zipF").innerHTML= "Zip/Pin code not in correct format.";
                zip.focus();
                return false;
            }
            else
            {
                document.getElementById("zipF").innerHTML= " ";   
            }
        }
    </script>
</head>
                ...
                <div class="col-lg-6" >
                                <div class="card"style="width: 900px;margin-left:100px">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" id = "addrform" name="addrForm" onsubmit="return formValidation();">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Area Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="areanm" name="areanm" placeholder="Patel Colony" class="form-control" required="true">
                                                    <span id="arF" style="color: red;"></span>
                                                    <small class="form-text text-muted">Enter Area Name to add it to Deliverable areas list..</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="zip" name="zip" placeholder="361008" class="form-control"  required="true">
                                                    <span id="zipF" style="color: red;"></span>
                                                    <small class="form-text text-muted">Enter Zip/Pin Code of the area.</small>
                                                </div>
                                            </div>
