<?php
    ...
    {
        $sql = "select name,email,orders_status,holiday_status from seller_details where seller_id='".$_SESSION['seller_id']."'";
        ...
        if(is_array($row))
        {
            ...
            $email = $row['email'];
            //$contact = $row['contact'];
            $request = $row['orders_status'];
            $maintanance = $row['holiday_status'];
        }
    }
        else
        {
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <form method="post" name="insert_data" id="insert_data" action="panel.php">
                                            <div class="row form-group">
                                                <!--<div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Requests Incoming</label>
                                                </div>-->
                                                <div class="col-12 col-md-9">
                                                    <!--<label class="switch switch-text switch-primary">
                                                    <input type="checkbox" class="switch-input" name="req1" checked="true">-->
                                                    <?php
                                                    if($request == 1)
                                                    {
                                                        echo "Orders Incoming: <input type='radio' name='req' value='1' checked>ON   "; 
                                                        echo "<input type='radio' name='req' value='0'>OFF";
                                                    }
                                                    else
                                                    {
                                                        echo "Orders Incoming: <input type='radio' name='req' value='1'>ON   "; 
                                                        echo "<input type='radio' name='req' value='0' checked>OFF";
                                                    }
                                                    ?>
                                                 ...
                                                 <input type="hidden" name="hidden_req" id="hidden_req" value="on" />
                                            </div>
                                            <div class="row form-group">
                                                <!--<div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Website On Maintainance Alert</label>
                                                </div>-->
                                                <div class="col-12 col-md-9">
                                                    <!--<label class="switch switch-text switch-primary">
                                                    <input type="checkbox" class="switch-input" name="man1">-->
                                                    <?php
                                                    if($maintanance == 1)
                                                    {
                                                        echo "Holiday: <input type='radio' name='man' value='1' checked>ON  "; 
                                                        echo "<input type='radio' name='man' value='0'>OFF";
                                                    }
                                                    else
                                                    {
                                                        echo "Holiday: <input type='radio' name='man' value='1'>ON  "; 
                                                        echo "<input type='radio' name='man' value='0' checked>OFF";
                                                    }
                                                    ?>
                                                    <!--<span data-on="On" data-off="Off" class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                ...
                                                <input type="hidden" name="hidden_man" id="hidden_man" value="off" />
                                            </div>
                                            
                                            <button class="btn btn-primary" type="submit" name="b1" value="Apply Changes">Apply Changes</button>
                                        </form>
